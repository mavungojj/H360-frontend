...
export default function PatientsPage() {
  ...
  const [form, setForm] = useState({ name: '', email: '', phone: '', gender: 'M' });
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left px-6 py-3 text-sm font-medium text-gray-600">Género</th>
              </tr>
            </thead>
            <tbody>
              {patients.map(p => (
                <tr key={p.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-gray-600">{p.gender === 'M' ? 'Masculino' : 'Feminino'}</td>
                </tr>
              ))}
            </tbody>
          </table>
